...
messageA = visual.TextStim(myWin,pos=(-200,140), alignHoriz='left',height=16, ori=00, color=(-1.00,-1.00,-1.00), text="A")
messageB = visual.TextStim(myWin,pos=(-200,140), alignHoriz='left',height=16, ori=00, color=(-1.00,-1.00,-1.00), text="B")
...
stimvals = numpy.array([ 0, 2, 4, 8, 28, 32]) + backsteal
stimreps = 6
